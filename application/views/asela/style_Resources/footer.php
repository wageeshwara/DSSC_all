<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2015 SLIIT Curtin CP Group 2</strong> All rights reserved.
</footer>
</div><!-- ./wrapper -->
...
<script src="<?php echo base_url();?>bootstrap/plugins/morris/morris.min.js" type="text/javascript"></script>
<!-- Sparkline -->
...
<script src="<?php echo base_url();?>bootstrap/dist/js/pages/dashboard.js" type="text/javascript"></script>
