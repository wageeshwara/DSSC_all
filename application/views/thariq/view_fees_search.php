...
<div class="content-wrapper" xmlns="http://www.w3.org/1999/html">
    ...
    <section class="content">
        ...
        <div class="row">
            <!-- Left col -->
            <form action="<?= site_url('sites/fees_search'); ?>" method="post" name="searchForm" onsubmit="return validateForm()">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Search Record</h3>
                    </div>
                    <div class="box-body">
                        <section class="col-md-4 ">
                            ...
                            <input type="submit" name="btn_fees_search"  button class="btn btn-block btn-primary"  value="Search" ></button>
