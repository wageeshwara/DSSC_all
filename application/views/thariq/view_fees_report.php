...
<div class="content-wrapper" xmlns="http://www.w3.org/1999/html">
    ...
    <section class="content">
        ...
        <div class="row">
            <!-- Left col -->
            <form action="<?= site_url('printController_t/fees_select'); ?>" method="post" name="searchForm" onsubmit="return validateForm()">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Print Fee Receipt</h3>
                    </div>
                    <div class="box-body">
                        <section class="col-md-4 ">
                            ...
                            <input type="submit" name="btn_generate"  button class="btn btn-block btn-primary"  value="Generate Receipt" ></button>
