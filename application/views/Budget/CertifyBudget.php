...
?>
      ...
      <div class="col-md-12"> 
        ...
        <div class="box box-primary"> 
          ...
          <a href="<?php echo site_url('/Budget/Accept/'.$object->UId.'/10') ?>"  class="btn btn-primary">Accept</a>&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="<?php echo site_url('/Budget/Accept/'.$object->UId.'/20') ?>"  class="btn btn-primary">Not Accept</a>
