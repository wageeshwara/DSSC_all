        ...
        <div class="row">
            ...
            <div class="col-md-7">
                ...
                <section class="col-lg-7 connectedSortable">
                    <div class="info-box">
                        <a href="viewHousePanelWeera"><span class="info-box-icon bg-light-blue-active"><i class="ion ion-ios-people-outline"></i></span></a>
                ...
                <section class="col-lg-7 connectedSortable">
                    <div class="info-box">
                        <a href="fillUpdateTextBoxWeera"><span class="info-box-icon bg-light-blue-active"><i class="fa fa-edit"></i></span></a>
                ...
                <section class="col-lg-7 connectedSortable">
                    <div class="info-box">
                        <a href="fillDeleteTextBoxWeera"><span class="info-box-icon bg-light-blue-active"><i class="fa fa-edit"></i></span></a>
