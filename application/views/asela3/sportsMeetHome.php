            ...
            <div class="col-md-7">
                ...
                <section class="col-lg-7 connectedSortable">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">Shura </span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                ...
                <section class="col-lg-7 connectedSortable">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text"></span>
                            <span class="info-box-number">Meththa</span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                ...
                <section class="col-lg-7 connectedSortable">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text"></span>
                            <span class="info-box-number">Weera </span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                ...
                <section class="col-lg-7 connectedSortable">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text"></span>
                            <span class="info-box-number">Shantha </span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                ...
                <section class="col-lg-7 connectedSortable">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text"></span>
                            <span class="info-box-number">Search Panel Members </span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
