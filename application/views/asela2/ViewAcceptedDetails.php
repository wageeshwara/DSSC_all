<div class="content-wrapper" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">
    ...
    <section class="content-header">
        ...
        <h1>
            Accepted Request Details <br> <br>
        </h1>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <br>
                <br><br>
                <a href="<?php echo base_url('index.php/AcceptControllers/AcceptedRequst?houseID=').$houseID; ?>"><button type="button"  class="btn btn-danger">Reject</button></a>&nbsp; &nbsp;
