            ...
            <table class="table table-condensed">
                ...
                <?php foreach($result as $result): ?>
                    <tr>
                        ...
                        <td><a href="<?php echo base_url('index.php/AcceptControllers/viewAccepted?houseID=').$result['houseID']; ?>"><button type="button"  class="btn btn-danger">View</button></a></td>
