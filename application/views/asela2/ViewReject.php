            ...
            <table class="table table-condensed">
                ...
                <?php foreach($result as $result): ?>
                    <tr>
                        ...
                        <td><a href="<?php echo base_url('index.php/AcceptControllers/viewRejected?houseID=').$result['houseID']; ?>"><button type="button"  class="btn btn-primary">View</button></a></td>
